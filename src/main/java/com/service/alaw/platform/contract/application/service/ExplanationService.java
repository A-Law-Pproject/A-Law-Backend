...
public class ExplanationService {
  ...
  public EasyExplanationResponse getEasyExplanation(EasyExplanationRequest request) {
    ...
    EasyExplanationResponse response = aiClient.getEasyExplanation(request.sentence());

    if (request.contractId() != null) {
      saveExplanation(request.contractId(), request.sentence(), response.easyExplanation());
    }
