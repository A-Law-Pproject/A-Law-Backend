...
public interface ContractManagementSpec {
    ...
    @Operation(
            summary = "계약서 생성",
            description = "새로운 계약서를 생성하여 내 문서함에 저장합니다."
    )
    @ApiResponses({
    ...
    @Operation(
            summary = "내 계약서 목록 조회",
            description = "현재 로그인한 사용자의 모든 계약서 목록을 조회합니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "계약서 삭제",
            description = "계약서를 삭제합니다. 본인의 계약서만 삭제할 수 있습니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "204",
    ...
    @Operation(
            summary = "계약서 수정",
            description = "계약서의 세부 정보를 수정합니다. 본인의 계약서만 수정할 수 있습니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
